<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCliente.Master" AutoEventWireup="true" CodeBehind="Produto.aspx.cs" Inherits="PAP_DanielMorgado.Produto" %>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-2  col-md-pull-5">
						<div id="product-imgs">
							<div class="product-preview">
								<asp:Image ID="Image1" runat="server" /><asp:Label ID="Label1" runat="server" Text="Label" Visible="false"></asp:Label>
							</div>
						</div>
					</div>
					<!-- /Product thumb imgs -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<span class="product-available">Em Stock : <asp:Label ID="lbl_quant" runat="server" Text="1" CssClass="product-available"></asp:Label></span>
							</div>
							<p></p>
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<asp:TextBox ID="txt_quantidade" runat="server" TextMode="Number" Required="true" Text="1"></asp:TextBox>
									</div>
								</div>
								<div>
									<br />
								<asp:Button ID="Button1" runat="server" Text="Adicionar ao Carrinho" CssClass="add-to-cart-btn" OnClick="Button1_Click"/>
								</div>
							</div>
							<ul class="product-links">
								<li>Categoria:</li>
								<li><asp:Label ID="lbl_categoria" runat="server" Text=""></asp:Label></li>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p><asp:Label ID="lbl_descricao" runat="server" Text="Label" Rows="20"></asp:Label></p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					...
					<asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" CellPadding="0" OnLoad="DataList1_Load" OnItemCommand="DataList1_ItemCommand" DataSourceID="SqlDataSource1">
                            <ItemTemplate>
								<!-- product -->
