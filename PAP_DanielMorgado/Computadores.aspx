<%@ Page Title="" Language="C#" MasterPageFile="~/MasterCliente.Master" AutoEventWireup="true" CodeBehind="Computadores.aspx.cs" Inherits="PAP_DanielMorgado.Computadores" %>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div id="store" class="col-md-9">
						...
						<!-- store products -->
						<asp:DataList ID="DataList1" runat="server" RepeatColumns="3" RepeatDirection="Horizontal" CellPadding="0" OnLoad="DataList1_Load" OnItemCommand="DataList1_ItemCommand" OnPreRender="DataList1_PreRender" OnItemDataBound="DataList1_ItemDataBound" OnSelectedIndexChanged="DataList1_SelectedIndexChanged" EditItemStyle-Width="30%">
                            <ItemTemplate>
								<!-- product -->
