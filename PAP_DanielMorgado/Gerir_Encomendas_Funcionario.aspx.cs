...
{
    public partial class Gerir_Encomendas_Funcionario : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           string z;
            ...
            MySqlConnection liga = new MySqlConnection(configuracao);
            MySqlDataReader DR1;
        ...
        protected void btn_criar_Click(object sender, EventArgs e)
        {
            ...
            if (Convert.ToDateTime(txt_data.Text) >= DateTime.Now)
            {
                ...
                {
                    ligar.Close();
                    Response.Redirect("Gerir_Encomendas_Funcionario.aspx", false);
                }
            }
            else
            {
